---
title: "Idaho Early Voting Statistics"
---
...
```
## {.tabset}
Last Report: `r state_stats[13,9]`  
Source:  `r state_stats[13,2]`

These data are only for Ada County; Idaho's most populous county.

### Returned Mail Ballots

Returned ballots: **`r format(as.numeric(state_stats[13,6]), big.mark =",")`**

### Mail Ballot Requests

Ballots requested: **`r format(as.numeric(state_stats[13,5]), big.mark =",")`** 