...
NC_reject_race[3,2] <- sum(state_stats[34,55]) 
NC_reject_race[4,2] <- sum(state_stats[34,56]) 
NC_reject_race[5,2] <- sum(state_stats[34,57]) 
...
NC_reject_race[3,4] <- sum(state_stats[34,35]) + sum(state_stats[34,55])
NC_reject_race[4,4] <- sum(state_stats[34,36]) + sum(state_stats[34,56])
NC_reject_race[5,4] <- sum(state_stats[34,37]) + sum(state_stats[34,57])
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Return Rates - Democrats") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale")
```
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Return Rates - Republicans") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale")
```
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Return Rates - No Party Affiliation") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale") 
```
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Return Rates - Minor Party") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale")
```
...
On the Sunday September 20, 2020 update, the North Carolina State Board of Elections removed all rejected records with the ballot status reason of "WITNESS INFO INCOMPLETE".
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Rejection Rates - Democrats") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale") 
```

``` {r echo = FALSE}
datatable(NC_stats_rejects_Dem, colnames = c("County", "All Mail Ballots Returned", "Mail Ballots Rejected", "Percent Rejected"), rownames = F) %>%
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Rejection Rates - Republicans") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale") 
```

``` {r echo = FALSE}
datatable(NC_stats_rejects_Rep, colnames = c("County", "All Mail Ballots Returned", "Mail Ballots Rejected", "Percent Rejected"), rownames = F) %>%
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Rejection Rates - No Party Affilation") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale")
```

``` {r echo = FALSE}
datatable(NC_stats_rejects_NPA, colnames = c("County", "All Mail Ballots Returned", "Mail Ballots Rejected", "Percent Rejected"), rownames = F) %>%
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Rejection Rates - Minor Party") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale")
```

``` {r echo = FALSE}
datatable(NC_stats_rejects_Minor, colnames = c("County", "All Mail Ballots Returned", "Mail Ballots Rejected", "Percent Rejected"), rownames = F) %>%
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Request Rates - Democrats") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale") 
```
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Request Rates - Republicans") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale")
```
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Request Rates - No Party Affilation") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale")
```
...
hcmap(map = "countries/us/us-nc-all", data = NC_2020g_map_data,
  ...
  hc_title(text ="Mail Ballot Request Rates - Minor Party") %>%
  hc_subtitle(text = "County plots may not be shaded using the same scale")
```
