...
NC_age_shell <- data.frame(Age=character(),
                                  ...
                                  Percent=double(),
                                  stringsAsFactors=FALSE)
age_shell[1,1] <- "18 to 25"
age_shell[2,1] <- "26 to 40"
age_shell[3,1] <- "41 to 65"
age_shell[4,1] <- "66 to up"
age_shell[5,1] <- "TOTAL"
...
NC_req_send_age[1,2] <- sum(NC_stats$Mail.Req.Age.1825)
NC_req_send_age[2,2] <- sum(NC_stats$Mail.Req.Age.2640) 
NC_req_send_age[3,2] <- sum(NC_stats$Mail.Req.Age.4165) 
NC_req_send_age[4,2] <- sum(NC_stats$Mail.Req.Age.65up) 
NC_req_send_age[5,2] <- sum(NC_stats$Mail.Req.Tot)
