...
NC_reject_race$Percent <- 100 * NC_reject_race$Count/NC_reject_race[7,2]
...
##### Mail Ballot Rejection Rates {.tabset .tabset-pills}
...
``` {r echo = FALSE}
datatable(NC_stats_rejects_nh_white, colnames = c("County", "Mail Ballots Returned", "Mail Ballots Rejected", "Percent Rejected"), rownames = F) %>%
...
``` {r echo = FALSE}
datatable(NC_stats_rejects_nh_black, colnames = c("County", "Mail Ballots Returned", "Mail Ballots Rejected", "Percent Rejected"), rownames = F) %>%
