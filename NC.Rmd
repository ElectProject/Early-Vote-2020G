...
At this point, all `r format(as.numeric(sum(NC_stats$Mail.Reject.Tot)), big.mark =",")` rejected mail ballots in the midst of the pandemic are for the reason noted as "WITNESS INFO INCOMPLETE".
