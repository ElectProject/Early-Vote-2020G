...
NC_req_send_age[1,2] <- sum(NC_stats$Mail.Req.Age.1825, rm.na = T)
NC_req_send_age[2,2] <- sum(NC_stats$Mail.Req.Age.2640, rm.na = T) 
NC_req_send_age[3,2] <- sum(NC_stats$Mail.Req.Age.4165, rm.na = T) 
NC_req_send_age[4,2] <- sum(NC_stats$Mail.Req.Age.65up, rm.na = T) 
NC_req_send_age[5,2] <- sum(NC_stats$Mail.Req.Tot, rm.na = T)
