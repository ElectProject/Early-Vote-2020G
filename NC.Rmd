...
North Carolina is the first state to begin general election voting. Election officials started sending ballots to voters on September 4.
...
NC_2020g_map_data <- mutate(NC_2020g_map_data, percent = round(100*Pct.Request, digits = 1))
