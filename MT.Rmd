...
Montana gave its local election officials the option of conducting an all-mail ballot election. It is my understanding that all counties have chosen to run an all-mail ballot election. Ballot requests reported here are counts of the state's registered voters.

### Mail Ballot Requests

``` {r echo = FALSE}
kable(MT_req_send_tot, format.args = list(big.mark = ",", 
