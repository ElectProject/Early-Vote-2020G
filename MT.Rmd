...
Montana gave its local election officials the option of conducting an all-mail ballot election. All but 10 smaller counties have chosen to run an all-mail ballot election. Ballot requests reported here are counts of the state's registered voters.
