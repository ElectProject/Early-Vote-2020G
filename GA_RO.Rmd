...
colnames(GA_voted_race) <- c("Race/Ethnicity", "In-Person Votes", "Freq. Distribution", "Registered Voters", "Turnout Rate")
...
colnames(GA_voted_age) <- c("Age", "In-Person Votes", "Freq. Distribution", "Registered Voters", "Turnout Rate")
...
colnames(GA_voted_voted) <- c("2020 General Voted", "In-Person Votes", "Freq. Distribution", "Registered Voters", "Turnout Rate")
...
Total Votes: **`r format(as.numeric(sum(GA_stats$Inperson.Accept.Tot) + sum(GA_stats$Mail.Accept.Tot)), big.mark =",")`**  
...
Total In-Person Votes: **`r format(as.numeric(sum(GA_stats$Inperson.Accept.Tot)), big.mark =",")`**  
Percent In-Person Votes (of Registered Voters): **`r paste(round(100*sum(GA_stats$Inperson.Accept.Tot)/sum(GA_stats$Reg.Voters), digits = 1),"%", sep = "")`**  
