...
FL_out_party[1,5] <- state_stats[10,29] 
FL_out_party[2,5] <- state_stats[10,30] 
FL_out_party[3,5] <- state_stats[10,31] 
FL_out_party[4,5] <- state_stats[10,32] 
FL_out_party[5,5] <- state_stats[10,6] 

FL_out_party[1,4] <- state_stats[10,10] 
FL_out_party[2,4] <- state_stats[10,11] 
FL_out_party[3,4] <- state_stats[10,12] 
FL_out_party[4,4] <- state_stats[10,13] 
FL_out_party[5,4] <- state_stats[10,5] 
