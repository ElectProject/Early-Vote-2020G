...
Maine registered Democrats have a **`r format(as.numeric(FL_req_send_party[1,2]-FL_req_send_party[2,2]), big.mark =",")`** ballot request lead over registered Republicans.
