...
Mail Ballot Requests **`r format(as.numeric(state_stats[43,8]), big.mark =",")`**  

### In-Person Votes

Mail Ballot Requests **`r format(as.numeric(state_stats[43,7]), big.mark =",")`**  

### Returned Mail Ballots

Mail Ballots **`r format(as.numeric(state_stats[43,6]), big.mark =",")`**  
