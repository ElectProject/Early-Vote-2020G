...
### Total Voted
Total Voted: **`r format(as.numeric(state_stats[37,8]), big.mark =",")`**

#### **Total Voted by Party Registration**
``` {r echo = FALSE}
kable(OK_voted_party, format.args = list(big.mark = ",", 
  scientific = FALSE), digits = 1) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
```

### In-Person Votes
In-Person Votes: **`r format(as.numeric(state_stats[37,7]), big.mark =",")`**

#### **In-Person Votes by Party Registration**
``` {r echo = FALSE}
kable(OK_inperson_party, format.args = list(big.mark = ",", 
  scientific = FALSE), digits = 1) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
```
