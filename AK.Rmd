---
title: "Alaska Early Voting Statistics"
---
...
```
## {.tabset}
Last Report: `r state_stats[2,9]`  
Source:  `r state_stats[2,2]`

### Returned Mail Ballots

Alaska voters have cast **`r format(as.numeric(state_stats[2,6]), big.mark =",")`** mail ballots.

### Mail Ballot Requests

Alaska voters have requested **`r format(as.numeric(state_stats[2,5]), big.mark =",")`** mail ballots.