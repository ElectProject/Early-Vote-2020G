---
title: "Delaware Early Voting Statistics"
---
...
```
## {.tabset}
Last Report: `r state_stats[8,9]`  
Source:  `r state_stats[8,2]`

### Returned Mail Ballots

Mail Ballots **`r format(as.numeric(state_stats[8,6]), big.mark =",")`**  

### Mail Ballot Requests

Mail Ballot Requests **`r format(as.numeric(state_stats[8,5]), big.mark =",")`**  
