...
Utah registered Republicans have a **`r format(as.numeric(UT_req_send_party[1,2]-UT_req_send_party[2,2]), big.mark =",")`** ballot request lead over registered Democrats.