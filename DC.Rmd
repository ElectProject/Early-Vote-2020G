...
The District of Columbia is running an all-mail ballot election on an emergency basis. Ballot requests reported here are counts of the state's registered voters.
