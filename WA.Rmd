...
Mail Ballots Returned: **`r format(as.numeric(state_stats[48,6]), big.mark =",")`**  
Return Rate: **`r paste(round(100*sum(state_stats[48,6]/state_stats[48,5]), digits = 1),"%", sep = "")`**

### Mail Ballot Requests

Mail Ballots Requested: **`r format(as.numeric(state_stats[48,5]), big.mark =",")`**  
