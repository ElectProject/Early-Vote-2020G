...
# Georgia U.S. Senate Run-Off Election

[GA Dashboard](https://electproject.github.io/Early-Vote-2020G/GA_RO.html)
...
* [Sunday, Nov. 1](https://electproject.github.io/Early-Vote-2020G/Early_Vote_Analysis_11_01.html)  
...
Total Early Votes: **`r format(as.numeric(sum(state_stats$total_early_2020)), big.mark =",")`** • In-Person Votes: **`r format(as.numeric(sum(state_stats$inperson_2020)), big.mark =",")`** • Mail Ballots Returned: **`r format(as.numeric(sum(state_stats$mail_accept_2020)), big.mark =",")`** • Mail Ballots Outstanding: **`r format(as.numeric(sum(state_stats$mail_sent_req_2020) - sum(state_stats$mail_accept_2020)), big.mark =",")`** 
...
hcmap(map = "countries/us/us-all", data = US_2020g_map_data,
  ...
  hc_title(text ="2020 Total Early Votes Cast as Percent of 2016 Total Turnout") %>%
  hc_subtitle(text = "State plots may not be shaded using the same scale")
```
