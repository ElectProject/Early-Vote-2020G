...
Total Early Votes: **`r format(as.numeric(sum(state_stats$total_early_2020)), big.mark =",")`** • Mail Ballots: **`r format(as.numeric(sum(state_stats$mail_accept_2020)), big.mark =",")`** • In-Person Votes: **`r format(as.numeric(sum(state_stats$inperson_2020)), big.mark =",")`**  
