...
Voters have cast a total of **`r format(as.numeric(sum(state_stats$mail_accept_2020)), big.mark =",")`** ballots in the reporting states of IL, NC, and SC. NC voters have cast nearly all of these ballots.
