...
Reporting states with party registration data: CA, CO, CT, FL, IA, KS, KY, LA, MD, ME, NC, NE, NJ, NM, NV, OK, PA, SD    
``` {r echo = FALSE}
...
Reporting states with party registration data: CA, CO, CT, FL, IA, KS, KY, MD, ME, NC, NE, NJ, NM, NV, OK, PA, SD  
``` {r echo = FALSE}
