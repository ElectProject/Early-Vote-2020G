...
Texas voters have cast **`r format(as.numeric(state_stats[44,8]), big.mark =",")`** mail ballots.  

### Returned Mail Ballots

Texas voters have cast **`r format(as.numeric(state_stats[44,7]), big.mark =",")`** mail ballots.  
