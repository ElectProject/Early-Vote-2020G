---
title: "Texas Early Voting Statistics"
---
...
```
## {.tabset}
Last Report: `r state_stats[44,9]`  
Source:  `r state_stats[44,2]`

### Total Voted

Total Voted: **`r format(as.numeric(state_stats[44,8]), big.mark =",")`**   

### In-Person Votes

In-Person Votes: **`r format(as.numeric(state_stats[44,7]), big.mark =",")`**    

### Returned Mail Ballots

Mail Ballots **`r format(as.numeric(state_stats[44,6]), big.mark =",")`**  
